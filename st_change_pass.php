...
?>
	<div class="profile">
		<h3 style="font-size:18px;text-align:center;background:#0000105e;color:#fff;padding:10px;margin:0">Update Your Profile</h3>			
<?php
		if($_SERVER['REQUEST_METHOD'] == "POST"){
			...
			if(empty($newpass) or empty($oldpass) or empty($confirmpass)){
				echo "<p style='color:red; text-align:center'>Fields can't be empty.</p>";
...
<?php } ?>
			...
			<div class="back fix">
				<p style="text-align:center"><a href="st_profile.php"><button class="editbtn">Back To Profile</button></a></p>
			</div>
</div>
