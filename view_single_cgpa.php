...
<div class="all_student fix">
	...
	?>
	<div class="fix">
	<p style="text-align:center;color:#fff;background:#0000105e;margin:0;padding:8px;"><?php echo $name."<br> " . $stid; ?></p>
	</div>	
	<div  class="fix">	
		<p style='text-align:center;background:#ddd;color:#01C3AA;padding:5px;width:84%;margin:0 auto'>My Transcript</p>
	</div>
<?php
	$i=0;
	$ch = 0;
...
?>		
	<div class="back fix">
		<p style="text-align:center"><a href="view_single_result.php?vr=<?php echo $stid?>&vn=<?php echo $name?>"><button class="editbtn">Back</button></a></p>
	</div>
</div>
