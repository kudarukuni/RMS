...
?>
<div class="profile">
		<p style="font-size:18px; text-transform:uppercase; text-align:center; background:#0000105e; color:#fff; padding:10px; margin:0"><?php $user->getusername($st_id); ?> <i class="fa fa-check-circle" aria-hidden="true"></i></p>
		<table class="tab_one">
			<?php
		...
		<div class="back fix">
			<p style="text-align:center"><a href="admin_all_student.php"><button class="editbtn">Back</button></a></p>
		</div>
