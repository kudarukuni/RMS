...
?>
	<div class="loginform fix">
		<div class="msg "><h3><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Faculty Login&nbsp;<i class="fa fa-user" aria-hidden="true"></i></h3></div>
		<div class="access">
			...
			if($_SERVER['REQUEST_METHOD'] == "POST"){
						...
						if(empty($username) or empty($psw)){
							echo "<p style='color:red;text-align:center;'>Field can't be empty</p>";
						}else{
							$psw = md5($psw);
