...
?>
<div class="profile">
		<p style="font-size:18px;text-align:center;background:#0000105e;color:#fff;padding:10px;margin:0">Welcome : <?php $user->getusername($sid); ?> <i class="fa fa-check-circle" aria-hidden="true"></i></p>
		<table class="tab_one">
			<?php
