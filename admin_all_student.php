...
<div class="all_student">
	<div class="search_st">
		<div class="hdinfo"><h3>Registered Students List</h3></div>	
		<div class="search">
		<form action="admin_search_student.php" method="GET">
			<input type="text" name="src_student" placeholder="Search" />
		...
		<?php
			if(isset($_REQUEST['res'])){
				if($_REQUEST['res']==1){
					echo "<h3 style='color:red; text-align:center; margin:0; padding:10px;'>Student Deleted Successfully</h3>";
				}
			}
		...
		<table class="tab_one">
			...
			<tr>
				...
				<td style="text-transform:uppercase;"><?php echo $rows['st_id'];?></td>
