...
<div class="all_student fix">
		...
		?>
		<div>
	<p style="text-align:center; text-transform:uppercase; color:#fff; background:#0000105e; margin:0; padding:8px;"><?php echo $name."<br>" . $stid; ?></p>
	</div>	
	<div>
	<p style="float:left; margin:0 0 5px 0; width:100%; text-align:left;"><a href="view_cgpa.php?vr=<?php echo $stid; ?>&vn=<?php echo $name; ?>"><button class="editbtn">View <font style="text-transform:uppercase;"><?php echo $name?></font>'s Transcript</button></a></p>
	</div>	
	...
	?>
	<p style="float:left; text-align:right;margin:20px 0;width:49%"><a href="st_result_update.php?ar=<?php echo $stid?>&seme=<?php echo $semester?>&vn=<?php echo $name?>"><button class="editbtn">Edit <font style="text-transform:uppercase;"><?php echo $name?></font>'s Results</button></a></p>
	<?php 
		}
	?>		
	<p style="float:right;text-align:left;margin:20px 0;width:49%"><a href="st_result.php"><button class="editbtn">Students List</button></a></p>
</div>
