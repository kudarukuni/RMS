...
<div class="all_student fix">
		...
		<div  class="fix" style="background:#ddd;padding:20px;">
			...
			<span style="float:right;"> <button style="background:#58A85D;border:none;color:#fff;padding:10px;"><a style="color:#fff;" href="class_att.php">Class Attendance</a></button></span>
		</div>
		<?php
			if(isset($_POST['sub'])){
				$name = $_POST['name'];
