...
<div class="all_student fix">
	...
	?>
	<div>
	<p style="text-align:center;color:#fff;background:#0000105e;text-transform:uppercase;margin:0;padding:8px;"><?php echo $name."<br> " . $stid; ?></p>
	</div>
	<div class="fix">
	<p style="float:left;margin:0 0 3px 0;width:100%;text-align:left;"><a href="view_single_cgpa.php?vr=<?php echo $stid; ?>&vn=<?php echo $name; ?>"><button class="editbtn">View Transcript</button></a></p>
	</div>		
