<?php
	...
	class PDF extends PDF_Rotate{
		function Header(){
			...
			$this->RotatedText(65,190,'A P P O V E D',45);
		}
	...
	$pdf=new PDF();
	$pdf->AddPage();
	$iubat='Results Management System' ;					
	...
	$pdf->Write(4,'Designed and Developed by Kudakwashe W. Rukuni &copy;');
	$pdf-> Cell(20);
	$pdf->SetFont('Times','',8);
