...
<div class="all_student fix">
	<h3 style="text-align:center;color:#fff; margin:0;padding:5px; background:#0000105e;">Attendance Management</h3>
	...
	<?php
		if(isset($_REQUEST['res'])){
			echo "<h3 style='color:white;margin:0;padding:0;text-align:center'>Data deleted successfully !</h3>";
		}
	?>
	<?php
		if($_SERVER['REQUEST_METHOD'] == 'POST'){
			...
			if($res){
				echo "<h3 style='color:white;margin:0;padding:0;text-align:center'>Attendance data successfully inserted!</h3>";
			}else{
