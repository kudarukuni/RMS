...
<div class="profile">
			<h3 style="font-size:18px; text-align:right; background:#0000105e; color:#fff; padding:10px; margin:0"><a href="admin_all_student.php"><button class="editbtn">All Students</button></a></h3>				
				<?php
					...
					if($_SERVER['REQUEST_METHOD'] == "POST"){
						...
						if(empty($st_name) or empty($st_email) or empty($st_contact) or empty($st_dept) or empty($st_gender) or empty($st_add)){
							...
							if($update){
								echo "<h4 style='color:red;text-align:center'>Student Updated Successfully</h4>";
							}else{
			...
			<div class="st_update fix">
				<form action="" method="post" enctype="multipart/form-data">
					...
					<table class="tab_one" >
						...
						<td></td>
						<td colspan="2">
							<input style="background:#01C3AA;color:#fff;width:168px;border-radius:5px;" type="submit" name="Update" value="Update">
							</td>						
						</tr>
					</table>
						<?php } ?>
